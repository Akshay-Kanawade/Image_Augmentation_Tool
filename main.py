...
from ops.grayscale import Gray
from ops.brightness import brightness
from ops.shift import Shift
from ops.sharpning import Sharp

EXTENSIONS = ['png', 'jpg', 'jpeg', 'bmp']
WORKER_COUNT = max(os.cpu_count() - 1, 1)
OPERATIONS = [Rotate, FlipH, FlipV, Translate, Noise, Zoom, Blur, Gray, brightness, Shift, Sharp]
    ...
    try:
        ...
        for op_list in op_lists:
            ...
            for op in op_list:
                img = op.process(img)
            cv2.imwrite(
                os.path.join(d, out_file_name), img)
